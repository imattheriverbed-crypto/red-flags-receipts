// Brand-styled HTML email templates shared by backend functions.
// Mirror of src/lib/emailTemplates.js (kept runtime-agnostic for the Deno backend).
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${INK};">
    <tr><td align="center" style="padding:24px 16px;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:${INK};border:1px solid ${ACCENT};">
        ...
        <tr><td align="center" style="padding:24px 32px 20px;">${hero}</td></tr>
        <tr><td style="padding:0 32px 24px;color:${PARCHMENT};font-family:'Playfair Display',Georgia,serif;font-size:16px;line-height:1.7;">${body}</td></tr>
        <tr><td align="center" style="padding:28px 32px;border-top:1px solid rgba(245,242,236,0.12);">
          <div style="font-family:'Playfair Display',Georgia,serif;font-style:italic;font-size:15px;color:rgba(245,242,236,0.75);line-height:1.5;">&ldquo;Look at this scarf made of all the red flags you gave me.&rdquo;</div>
        </td></tr>
        <tr><td align="center" style="padding:0 32px 36px;">
          <div style="font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:0.3em;color:rgba(245,242,236,0.4);text-transform:uppercase;">WARNING: WEARING THIS SCARF MAY CAUSE UNRESOLVED EXES TO TEXT YOU.</div>
        </td></tr>
        <tr><td style="height:6px;background:repeating-linear-gradient(45deg,${INK},${INK} 16px,${ACCENT} 16px,${ACCENT} 32px);font-size:0;line-height:0;">&nbsp;</td></tr>
      </table>
    </td></tr>
