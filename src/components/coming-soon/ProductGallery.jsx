...
import { Bell, Check, Crown, PawPrint, ReceiptText } from 'lucide-react';
...
const FITNESS_IMG = 'https://media.base44.com/images/public/6a5a113aa6cf7e3091bf0eec/523f2a179_19f3a17c86812.jpg';
const SHOES_IMG = 'https://media.base44.com/images/public/6a5a113aa6cf7e3091bf0eec/7138bd9d5_a716a32e-0643-449d-9c6d-1ef8cafef6d8.png';
...
const DROPS = [
  ...
  { trait: 'WORKOUT.', desc: 'Patchwork of every excuse they ever gave you — worn loud. Performance activewear for the one who survived, learned, and leveled up.', img: FITNESS_IMG, drop: 'Sep 05', tone: 'fitness', fit: true },
  { trait: 'FUR BOOTS.', desc: 'Premium faux leather with warm fur lining. Hidden messages inside: the right one will not make you question. Designed for the ones who walk away.', img: SHOES_IMG, drop: 'Sep 12', tone: 'shoes', fit: true },
];
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-ink border-2 border-primary">
        ...
        <div className="absolute top-4 left-4 flex items-center gap-2">
          <span className="font-mono-flag text-[9px] uppercase tracking-[0.2em] text-parchment bg-primary px-3 py-1">
            {drop.tone === 'empower' ? 'Empowerment Drop' : drop.tone === 'pets' ? 'Pet Drop' : drop.tone === 'bags' ? 'Bag Drop' : drop.tone === 'journal' ? 'Receipts Journal Drop' : drop.tone === 'fitness' ? 'Workout Drop' : drop.tone === 'shoes' ? 'Fur Boots Drop' : `Drop ${drop.drop}`}
          </span>
        </div>
